 ...
 * @since 2025-01-03
 */
public class DotNetEditorsProvider2 extends XDebuggerEditorsProviderBase {
    private final XDebugSession mySession;
    private final LanguageFileType myLanguageFileType;

    public DotNetEditorsProvider2(@Nullable XDebugSession session, RunProfile runProfile) {
        mySession = session;
        myLanguageFileType = findLanguageFileType(runProfile);
    }

    @Nonnull
    private static LanguageFileType findLanguageFileType(RunProfile runProfile) {
